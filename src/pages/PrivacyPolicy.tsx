...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800">
      ...
      <p className="text-sm text-gray-500 mb-8">Last updated: June 06, 2025</p>
      ...
      <ul className="list-disc list-inside space-y-2 mb-4">
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CarbonYield.</li>
        ...
        <li><strong>Website</strong> refers to CarbonYield, accessible from{' '}
          <a
            href="http://www.carbonyield.net"
      ...
      <h3 className="text-xl font-medium mt-10 mb-4">Use of Your Personal Data</h3>
      ...
      <h3 className="text-xl font-medium mt-10 mb-4">Retention of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-medium mt-10 mb-4">Transfer of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-medium mt-10 mb-4">Delete Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-medium mt-10 mb-4">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="text-xl font-medium mt-10 mb-4">Security of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <ul className="list-disc list-inside mb-10">
        <li>By email: <a href="mailto:hello@carbonyield.net" className="text-blue-600 underline">hello@carbonyield.net</a></li>
      </ul>
    </div>
  );
}
